...
class Programmer
{
    ...
    {
        Console.WriteLine("Програміст починає писати код");
    }
    public void StopCoding()
    {
        Console.WriteLine("Програміст закінчує писати код");
    }
}
...
class Tester
{
    ...
    {
        Console.WriteLine("Тестувальник починає тестування");
    }
    public void StopTest()
    {
        Console.WriteLine("Тестувальник закінчує тестування");
    }
}
...
class Marketolog
{
    ...
    {
        Console.WriteLine("Маркетолог починає рекламувати продукт");
    }
    public void StopAdvertize()
    {
        Console.WriteLine("Маркетолог закінчує рекламування");
    }
}
